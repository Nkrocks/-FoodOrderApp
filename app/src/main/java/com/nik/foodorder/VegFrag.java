...
import com.nik.foodorder.databinding.FragmentVegBinding;
...
public class VegFrag extends Fragment {
   // com.nik.foodorder.databinding.ActivityMainBinding binding;
     ...
     * @return A new instance of fragment VegFrag.
     */
    // TODO: Rename and change types and number of parameters
    public static VegFrag newInstance(String param1, String param2) {
        VegFrag fragment = new VegFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVegBinding.inflate(getLayoutInflater());
